...
class Reporte extends Doctrine_Record {
    ...
    public function getReporteAsMatrix($params = array(), $limit = null, $offset = null) {
        ...
        log_message('debug', 'class reporte.php -> getReporteAsMatrix; $params: ' . json_encode($params));
